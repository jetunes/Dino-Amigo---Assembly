...
Fila2 BYTE 1, 0, 0, 0, 0, 0, 0, 0

ArvoreX BYTE 9												; Declarando o tamanho dos eixos dos obstaculos
ArvoreY BYTE 5
...
DinoX BYTE 6												; Declarando o tamanho dos eixos personagem
DinoY BYTE 6
Dino BYTE 32,  32,  254, 254, 254, 32,
		  32,  32,  254, 32,  254, 254,
		  254, 32,  254, 254, 254, 254,
		  254, 254, 254, 254, 32,  32,
		  254, 254, 254, 254, 32,  32,
		  32,  254, 32,  254, 32,  32 
...
;INVOKE PlaySound, ADDR warning, NULL, eax		; tocar música de vitória
	...
	mov dh, 23			; na posição acima do texto de ajuda
	...
	mov dl, 2			; definindo onde a proxima coisa sera impressa		 
	mov dh, 26			; na posição abaixo do texto de ajuda, na ultima linha
	call GotoXY			; atualiza o cursor para essa posição
	...
	mov ecx, 26		    ; contador de loop atualizado com o valor 23
...
Desenha_Dino PROC
	...
	mov ecx, 6 							; contador do laço de repetição
	...
	Linha: 									; Printando as Linhas
		...
		mov ecx, 6 							; Contador loop Linha = 9
...
Apaga_Dino PROC
	...
	mov ecx, 6							; contador de loop é igual a quantidade de linhas que o personagem tem 
	mov al, 32							; auxiliar de impressão é atualizado com o caracter vazio

	Linha:
		PUSH ecx 							; empilha ecx
		mov ecx, 6							; atualiza o contador de laços com a quantidade de caracteres que um obstaculo tem por linha
		Coluna:
			call WriteChar					; imprime o caracter vazio
			LOOP Coluna
...
Colisao PROC
	...
	.IF vidinha == 0
		...
		mov dl, 60  						; escolhe a coluna em que o cursor sera setado
		mov dh, 25							; escollhe a linha em que o cursor sera setado
		call GotoXY
